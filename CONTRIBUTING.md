...
### Ticket?
    * Does the ticket exist?
      	 - Did you find a ticket that you want to work on, or that describes you problem? Assign the ticket to yourself and update the status if nessecary. 
    * Do you need to create a ticket? 
      	 - If so, make sure to provide a good description of the problem, and link it to any related tickets. Again, make sure you assign it to yourself.
